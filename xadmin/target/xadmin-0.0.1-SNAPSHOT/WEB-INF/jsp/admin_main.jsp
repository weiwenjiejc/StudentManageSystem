			...
			<ul id="nav">
				<li><a href="javascript:;"> <i class="iconfont left-nav-li"
					...
					<li>
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('查询教师','${sms }/teacher/listTeacher')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>查询教师</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('添加教师','${sms}/teacher/addTeacher')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>添加教师</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('修改教师','${sms}/teacher/updateTeacher')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>修改教师</cite></a>
                            </li>
                        </ul>
				...
				<li><a href="javascript:;"> <i class="iconfont left-nav-li"
						lay-tips="课程选择">&#xe723;</i> <cite>学生管理</cite> <i
						class="iconfont nav_right">&#xe697;</i></a>
					<ul class="sub-menu">
						<li><a
							onclick="xadmin.add_tab('查询学生','${sms}/student/listStudent')">
								<i class="iconfont">&#xe6a7;</i> <cite>查询学生</cite>
						</a></li>
						<li><a onclick="xadmin.add_tab('添加学生','${sms}/student/addStudent')">
								<i class="iconfont">&#xe6a7;</i> <cite>添加学生</cite>
						</a></li>
						<li><a onclick="xadmin.add_tab('修改学生','${sms}/student/updateStudent')">
								<i class="iconfont">&#xe6a7;</i> <cite>修改学生</cite>
						</a></li>
					</ul></li>
			</ul>
		</div>
