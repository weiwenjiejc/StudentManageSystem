		...
		<div class="layui-row">
			<form class="layui-form">
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input readonly="readonly" type="text" id="L_email" name="teacher_number" required=""
							lay-verify="teacher_number" autocomplete="off" class="layui-input" value="${LoginUser.teacher_number}">
					</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" id="L_username" name="course_number" required=""
							lay-verify="nikename" autocomplete="off" class="layui-input">
					</div>
				</div>
				<div class="layui-form-item">
					<label for="L_pass" class="layui-form-label"> <span
						class="x-red">*</span>课程总量
					</label>
					<div class="layui-input-inline">
						<input type="text" id="L_pass" name="total" required=""
	...
	<script>
		layui.use([ 'form', 'layer', 'jquery' ], function() {
			...
			form.on('submit(add)', function(data) {
				...
				$.ajax({
					url : "${sms }/teacher/request/addTeacherCourse",
