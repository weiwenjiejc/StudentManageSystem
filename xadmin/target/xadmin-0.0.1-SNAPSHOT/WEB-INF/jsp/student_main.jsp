...
<body class="index">
	...
	<div class="container">
		...
		<ul class="layui-nav right" lay-filter="">
			<li class="layui-nav-item"><a href="javascript:;">${LoginUser.student_name }</a>
				<dl class="layui-nav-child">
					<!-- 二级菜单 -->
					<dd>
		...
		<div id="side-nav">
			<ul id="nav">
				<li><a href="javascript:;"> <i class="iconfont left-nav-li"
						...
						<ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('我的资料','${sms }/student/updateStudent2')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>个人资料</cite></a>
                            </li>
                            <%-- <li>
                                <a onclick="xadmin.add_tab('已选课程','${sms }/student/haveSelectCourse')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>已选课程</cite></a>
                            </li> --%>
                        </ul>
					...
					<li>
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('选课查询','${sms }/student/listCourse')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>选课查询</cite></a>
                            </li>
                            <%-- <li>
				...
				<li><a href="javascript:;"> <i class="iconfont left-nav-li"
						lay-tips="课程选择">&#xe723;</i> <cite>我的课程</cite> <i
						class="iconfont nav_right">&#xe697;</i></a>
					<ul class="sub-menu">
					<li>
                                <a onclick="xadmin.add_tab('已选课程','${sms }/student/haveSelectCourse')">
						...
						<%-- <li><a
							onclick="xadmin.add_tab('课程查询','${sms}/student/listCourse')">
								<i class="iconfont">&#xe6a7;</i> <cite>课程查询</cite>
						</a></li>
						<li><a onclick="xadmin.add_tab('已选课程','${sms}/student/haveSelectCourse')">
